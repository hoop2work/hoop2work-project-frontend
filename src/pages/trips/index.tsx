              ...
              >
                ...
                <div className="absolute inset-0 bg-black bg-opacity-60 flex flex-col justify-center items-center opacity-0 group-hover:opacity-80 transition-opacity duration-300">
                  ...
                  <p className="text-white mb-1">
                    Departure: <TimeOnly isoDateTime={trip.departureTimeDestination} /> – Arrival: <TimeOnly isoDateTime={trip.arrivalTimeDestination} />
                  </p>
                  <p className="text-white mb-1">
                    Return flight: <TimeOnly isoDateTime={trip.departureTimeHome} /> – Back home: <TimeOnly isoDateTime={trip.arrivalTimeHome} />
                  </p>
                  <p className="text-white mb-1 font-semibold">Price: {trip.price} €</p>
                  <p className="text-white mb-4 text-center px-4">{trip.description}</p>
                  <button
